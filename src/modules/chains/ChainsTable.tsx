...
import { ChainsTableCellHead, ChainsTableCellText } from '@/modules';
...
export const ChainsTable = ({ filter }: ChainsTableProps) => {
  ...
  return (
    <TableContainer>
      <Table aria-label="chains table">
        <TableHead>
          <TableRow>
            <ChainsTableCellHead title="Chain name" />
            ...
            <>
              {chains.map((chain) => (
                ...
                >
                  ...
                  <ChainsTableCellText text={chain.service} />
